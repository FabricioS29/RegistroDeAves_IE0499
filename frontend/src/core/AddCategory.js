...
const AddCategory = () => {
    ...
    const handleChange = (event) => { //Agregar el nombre cada vez que escribe
        setError('');
    ...
    const clickSubmit = (event) => {
        ...
        setError('');
        setSuccess(false);
        // Petición a la API para crear nueva categoría
        ...
        <form onSubmit={clickSubmit}>
            <div className="mb-3">
                ...
                <input type="text" className="form-control"
                    onChange={handleChange} value={name} requerid autoFocus/>
            </div>
